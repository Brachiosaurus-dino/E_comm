import koreanGirl from '/korean_girl.jpg';
import koreanGirl2 from '/koren-girl-side-post.jpg';
import mainInBlackAndWhite from '/man-in-BW.jpg';
    ...
    <>
      <div>
        <section className="justify-center  pt-[200px] pb-[120px]  flex flex-col items-center bg-black py-25 w-full ">
          ...
          <p className="text-white text-5xl font-bold font-ubuntu text-center  ">
            About Us
          </p>
        </section>
        ...
        <section className="bg-white ">
          <p className="text-center pt-20 text-gray-400">
            Ready To Help Our Team
          </p>
          <p className="text-center  text-6xl font-bold font-ubuntu text-black py-5">
            Our Team
          </p>
          <div className="w-full container mx-auto grid grid-cols-1 sm:grid-cols-2 space-x-6 md:grid-cols-3 lg:grid-cols-4 items-center text-center gap-6 px-10 py-8">
            {peoples.map((people) => (
              <div>
                ...
                <p className="text-center text-2xl font-bold font-ubuntu pt-5 text-black">
                  {people.caption1}
                </p>
                <p className="text-center text-black font-ubuntu pt-3 pb-10">
                  {people.posts}
                </p>
              </div>
            ))}
        ...
        <section className="bg-[#f7f6f5]">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 container mx-auto pt-10 md:pt- h-full w-full ">
            <div className="px-20">
              <p className="md:text-5xl text-2xl  text-black sm:text-left text-center font-bold font-ubuntu mb-10 leading-loose">
                Shop The 5 Biggest Shoe Trends
              </p>
              <p className="md:text-2xl text-xl text-center md:text-left text-gray-400 font-ubuntu">
                {' '}
              ...
              <div className="flex justify-center md:justify-start">
                <button
                  className="h-20 mt-20 w-40 text-xl font-ubuntu md:items-center bg-red-600"
                  type="button"
                >
                  Shop Know
                </button>
            ...
            <div className=" flex items-center align-middle pl-20 mt-10 md:mt-0 md:pl-0 justify-center">
              <img
                className="md:h-250 h-full  w-full pr-20"

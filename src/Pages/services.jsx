      ...
      <div className="">
        ...
        <div className="w-full px-4 md:px-20 py-10 bg-gray-200 grid grid-cols-1 md:grid-cols-2 gap-8 ">
          {Captoins.map((caption) => (
            <div
              key={caption.index}
              className="bg-[#121214] text-white p-15 py-30 hover:bg-red-600 flex container mx-auto flex-col sm:flex-row items-start gap-5"
            >
        ...
        <div className="grid place-items-center bg-white w-full ">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 px-5 py-7 place-items-center lg:px-30 container mx-auto">
            <img
              src="/gucci-removebg-preview.png"
              alt="1"
            ...
            />
            <img
              src="/adidas-removebg-preview.png"
              alt="3"
              className="w-60 h-40 object-cover"
            />
            <img
              src="/sony-removebg-preview.png"
              alt="4"
          ...
          <div className="place-items-center grid lg:gap-20 px-6 py-4 lg:py-15 grid-cols-1 lg:grid-cols-2 lg:px-30 container mx-auto ">
            <div className="">
              <img
                ...
                src="/pexels-ionela-mat-268382825-32582889.jpg"
                alt="1"
              />
            </div>
            <div>
              <p className="text-red-600 text-2xl pt-5 lg:pt-0 font-bold">
                Our mission
              </p>
              <p className="font-bold text-5xl/15 pt-1  font-ubuntu ">
                Your Personal Styling Team Always Here
              </p>
              <p className=" pt-1 text-gray-400 leading-loose">
              ...
              <button
                className="bg-white border-2 hover:bg-red-600 border-black p-4  h-17 w-40 mt-4 text-black"
                type="button"
              >
                More Detail
              </button>

...
function Home() {
  ...
  const catalogs = [
    {
      id: 5,
      src: '/Check_out_our_cap_selection_-removebg-preview.png',
    ...
    {
      id: 6,
      src: '/Zenni_Round_Eyeglasses_Gray_Stainless_Steel-removebg-preview.png',
    ...
    {
      id: 7,
      src: '/Nike_Air_Force_1__07_LV8_Men_s_Shoes__Black_-removebg-preview.png',
      caption1: 'Gray Shoes',
      price: '$50',
      caption3: 'sneakers',
    },
    {
      id: 8,
      src: '/Manfinity_Hypemode_Men_Color_Block_Playing_Card_Print_Short_Sleeve_Button_Up_Collar_Shirt_Without_Tee-removebg-preview.png',
  ...
  const images_2 = [
    {
      id: 1,
      src: '/Dönme dolap _Texting (Tamamlandı).jpg',
      caption1: '461 Articles',
      caption2: 'Jackets',
    },
    {
      id: 2,
      src: '/Spring AI Bags Collection.jpg',
  ...
  const images_3 = [
    ...
    {
      id: 3,
      src: '/young-woman-4266712_1280.jpg',
      ...
      <div>
        <div className="relative w-full max-w-screen-xl pt-[110px] mx-auto">
          <img
            ...
            src="/Minimalist-Fashion-Product-Banner.png"
            alt="Banner Image"
          />

          <button className="absolute left-4 bottom-6 text-xs sm:text-sm md:text-base py-1 px-3 sm:py-2 sm:px-5 md:py-3 md:px-6 bg-red-600 lg:ml-5 text-black font-medium font-ubuntu">
            Explore Now
          </button>
        </div>
          ...
          <div className="w-full container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 items-center text-center gap-6 px-4 py-8">
            {images.map((image) => (
              <div key={image.id} className="text-center">
                ...
                <p className="text-md sm:text-xl mt-5 font-bold break-words">
                  {image.caption1}
                </p>
        ...
        <div className="bg-white w-full py-20">
          <div className="container mx-auto px-4 sm:px-8">
            ...
            <div className=" text-center">
              ...
              <p className="text-4xl sm:text-5xl lg:text-6xl font-ubuntu text-black">
                New Arrivals
              </p>
            </div>
            ...
            <div className="pt-10 sm:pt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
              {catalogs.map((catalog) => (
                <div key={catalog.id} className="flex flex-col h-full">
                  ...
                  <p className="pt-2 text-sm sm:text-base font-ubuntu">
                    {catalog.price}
                  </p>
                  <p className="pt-2 text-sm sm:text-base font-ubuntu">
                    {catalog.caption3}
        ...
        <div className="container mx-auto bg-transparent py-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 px-4">
            {images_2.map((image_2) => (
              <div
                key={image_2.id}
                className="relative w-full h-102 sm:h-80 md:h-156 overflow-hidden "
              >
                <img
                  src={image_2.src}
                  alt={image_2.caption1}
                ...
                <div className="absolute bottom-0 w-full lg:w-70 bg-black bg-opacity-80 text-white p-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold font-ubuntu">
                    {image_2.caption2}
                  </h2>
                </div>
              </div>
            ...
            <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center px-4 lg:px-0 relative">
              ...
              <div className="bg-black text-white p-10 w-full lg:w-1/3 z-10 relative font-ubuntu">
                <div className="bg-transparent p-10 text-left">
                  ...
                  <p className="text-sm leading-relaxed mb-3">
                    Dictum purus viverra accumsan in nisl.
                  </p>
        ...
        <div className="bg-white w-full pt-1">
          <h2 className="text-center font-ubuntu text-xl text-black pt-10">
            Check out popular products
          </h2>
          <h1 className="text-center font-ubuntu text-5xl text-black pt-10">
            Popular Products
          </h1>
          ...
          <div className="container mx-auto gap-8 content-center justify-center pt-10 lg:pt-10 flex flex-wrap grid-cols-3">
            {images_3.map((image3) => (
              <div
                key={image3.id}
                className="max-w-md justify-center content-center"
              >
                <a href="#">
                ...
                <div className="p-5">
                  <a href="#">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight font-ubuntu text-black">
                      {image3.caption1}
                    </h5>
                  </a>
                  ...
                  <a href="#">
                    <h5 className="mb-3 font-normal font-ubuntu text-sm dark:text-gray-400">
                      {image3.caption4}
                    </h5>
                  </a>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="relative w-full max-w-8xl mx-auto overflow-hidden">
              ...
              <img
                ...
                src="/pexels-christian-heitz-285904-842711.jpg"
                alt="newsletter"
              />
